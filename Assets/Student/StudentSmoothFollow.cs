...
{
    public class StudentSmoothFollow : MonoBehaviour
	{
        ...
        void LateUpdate()
		{
            ...
            if (raycastHit)
            {
                ...
                float smoothZ = Mathf.Lerp(transform.position.z, raycastInfo.point.z + rayDirection.z/2, heightDamping * 2 * Time.deltaTime);
